/**
 * PlaceHUD.tsx - Header avec contrôles pour Dual Flow
 *
  ...
  return (
    <div className="shrink-0 flex flex-col items-center">
      ...
      >
        ...
        {showAdaptiveZone && snapshot.adaptiveZone !== null && (
        ...
        <div className="w-full max-w-[200px] h-[3px] mt-3 rounded-full overflow-hidden bg-woven-cell-rest/30">
          ...
          >
            <svg className="w-full h-full" aria-hidden="true">
              ...
              <rect width="100%" height="100%" fill="url(#flow-progress-hatch)" />
            </svg>
          </div>
        </div>
      )}
