...
import {
  ...
  GEN_TARGET_PROBABILITY_DEFAULT, GEN_LURE_PROBABILITY_DEFAULT,
  DEFAULT_N_LEVEL, DEFAULT_TRIALS_COUNT_TEMPO, MODE_COLOR_DUAL_CATCH,
} from './thresholds';
...
export const DualCatchSpec: ModeSpec & { extensions: DualCatchExtensions } = {
  metadata: { id: 'dual-catch', displayName: 'Dual Catch', description: 'Attrape les correspondances N-back.', tags: ['training', 'default', 'adaptive'], difficultyLevel: 3, version: '1.0.0' },
  ...
  generation: { generator: 'Sequence', targetProbability: GEN_TARGET_PROBABILITY_DEFAULT, lureProbability: GEN_LURE_PROBABILITY_DEFAULT, sequenceMode: 'tempo' },
  defaults: { nLevel: DEFAULT_N_LEVEL, trialsCount: DEFAULT_TRIALS_COUNT_TEMPO, activeModalities: ['position', 'audio'] },
  adaptivity: { algorithm: 'adaptive', nLevelSource: 'user', configurableSettings: ['nLevel', 'activeModalities', 'algorithm'] },
  report: { sections: ['HERO', 'RECENT_TREND', 'PERFORMANCE', 'CONFIDENCE_BREAKDOWN', 'ERROR_PROFILE', 'SPEED', 'NEXT_STEP', 'REWARD_INDICATOR', 'DETAILS'], display: { modeScoreKey: 'report.modeScore.dprime', modeScoreTooltipKey: 'report.modeScore.dprimeTooltip', speedStatKey: 'report.speed.reactionTime', colors: MODE_COLOR_DUAL_CATCH } },
  ...
  extensions: { guidedMode: false, mirrorMode: false, gameCountdownMode: false, gameShowProgressBar: true, gameShowNLevel: true, adaptiveTargetDPrime: 2.2, fixedStimulusDurationMs: TIMING_STIMULUS_TEMPO_MS },
};
