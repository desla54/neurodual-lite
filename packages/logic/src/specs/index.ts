/**
 * Specs Index - Central Export (NeuroDual Lite)
 *
 * Trimmed version: only brainworkshop, dualnback-classic, stroop modes.
 *
 * THE SPEC HUB:
 *
 ...
 * - stroop.spec.ts       → Stroop task
 *
 * Usage:
 *   import { SimBrainWorkshopSpec, THRESHOLDS } from '@neurodual/logic/specs';
 */
 ...
 * NeuroDual Lite: only brainworkshop, dualnback-classic, stroop.
 */
 ...
 * NeuroDual Lite: only the 3 supported modes.
 */
